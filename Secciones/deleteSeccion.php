<?php
    ...
    if (isset($_POST) && !empty($_POST)){
        ...
        if ($remove){
            $error = '<div class="alert alert-success" role="alert">Sección eliminada correctamente</div>';
        } else{
            $error = '<div class="alert alert-danger" role="alert"><Error al eliminar Sección</div>';
        }
    }
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>Elimina Secciones e-Commerce</title>
</head>
<body>
    ...
    <div class="container">
        ...
        ?>
        <h2 class="text-center mb-5">Elimina Secciones</h2>
        <form method="post" enctype="multipart/form-data">
            <div class="row">
                <div class="col-4"></div>
                <div class="col-4">
                    <input type="text" name="seccionNombre" id="seccionNombre" placeholder="Nombre de la Sección" require class="form-control" value=<?= $data->seccionNombre ?>>
